...
/**
 * Created by Jérémy on 24/01/2015.
 */

/**
 * cette classe recupere sur Internet permet de creer un EditText avec un bouton clear
 * https://alinberce.wordpress.com/2012/02/20/android-edittext-with-custom-font-and-clear-button/
 */
public class MyEditText extends EditText {

    //The image we are going to use for the Clear button
    private Drawable imgCloseButton = getResources().getDrawable(R.drawable.croix);
